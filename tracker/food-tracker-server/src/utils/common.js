...
exports.calculateStreak = exports.calculateAge = exports.SYSTEM_PROMPT = void 0;
...
const calculateStreak = async (userId) => {
    const { data: logs } = await clients_1.supabase.from('food_logs').select('created_at').eq('user_id', userId).order('created_at', { ascending: false }).limit(100);
